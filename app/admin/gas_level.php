      ...
      <div class="stats-grid stagger" style="grid-template-columns:repeat(auto-fit,minmax(180px,1fr))">
        ...
        <div class="stat-card fade-up">
          ...
          <div class="gauge-bar mt-1">
            <div class="gauge-fill <?= $avg<25?'danger':($avg<50?'warn':'') ?>" style="width:<?= min(100,$avg) ?>%"></div>
          </div>
        </div>
        ...
        <div class="panel-body">
          <div class="table-wrap">
            <table class="data-table">
              <thead>
                <tr><th>#</th><th>User</th><th>Pressure (kPa)</th><th>Tank Fill (%)</th><th>Recorded At</th><th></th></tr>
              </thead>
              <tbody>
                  ...
                  <td>
                    <div class="flex items-center gap-2">
                      ...
                      <div class="gauge-bar" style="width:80px;flex-shrink:0">
                        <div class="gauge-fill <?= $r['gas_percentage']<25?'danger':($r['gas_percentage']<50?'warn':'') ?>"
                ...
                <?php endforeach; ?>
                <?php if (!$rows): ?>
                <tr><td colspan="6" class="text-center text-muted" style="padding:32px">No gas level records yet.</td></tr>
                <?php endif; ?>
              </tbody>
            </table>
          </div>
