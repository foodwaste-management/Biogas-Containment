...
<div class="layout">
  ...
  <div class="main-content">
    ...
    <div class="page-body">
      ...
      <!-- Banner -->
      <div class="panel"
        style="background:linear-gradient(135deg,var(--green-900),var(--green-800));border:none;margin-bottom:24px;">
        <div class="panel-body flex items-center justify-between" style="flex-wrap:wrap;gap:16px;">
          <div>
            <p
              style="color:var(--green-300);font-size:.75rem;font-family:var(--font-mono);text-transform:uppercase;letter-spacing:.1em;margin-bottom:6px;">
              System Control</p>
            <h2 style="font-family:var(--font-serif);font-size:1.6rem;color:#fff;margin-bottom:6px;">Biogas Monitoring —
              Admin Panel</h2>
            <p style="color:rgba(255,255,255,.65);font-size:.875rem;">Full access to users, sensor data, and system
              logs.</p>
          </div>
      ...
      <div class="panel fade-up">
        ...
        <div class="panel-body flex gap-2" style="flex-wrap:wrap;">
          ...
          <a href="<?= BASE_URL ?>/app/admin/methane.php" class="btn btn-secondary">Methane</a>
