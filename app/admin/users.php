...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($action === 'delete') {
    ...
    if ($uid === currentUserId()) {
      ...
      $uRow = $db->prepare("SELECT email FROM users WHERE user_id=:u");
      $uRow->execute([':u' => $uid]);
      $uRow = $uRow->fetch();
...
<div class="layout">
  ...
  <div class="main-content">
    ...
    <div class="page-body">
      ...
      <?php if ($err): ?>
        <div class="alert alert-error"><?= e($err) ?></div><?php endif; ?>
            ...
            <div class="sensor-form-grid">
              ...
              <div class="form-group">
                ...
                <div style="display:flex;align-items:center;gap:8px;padding:10px 0;">
                  ...
                  <label for="verified"
                    style="font-size:.875rem;font-weight:400;text-transform:none;letter-spacing:0;">Account
                    active</label>
                </div>
              </div>
            </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <form method="POST" style="display:inline">
                        ...
                        <button type="submit" class="badge <?= $u['verified'] ? 'badge-safe' : 'badge-leak' ?>"
