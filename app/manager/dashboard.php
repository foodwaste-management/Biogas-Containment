    ...
    <div class="page-body">
      ...
      <div class="stats-grid stagger">
        ...
        <div class="stat-card fade-up">
          ...
          <div class="gauge-bar mt-1">
            <div class="gauge-fill <?= $avg < 25 ? 'danger' : ($avg < 50 ? 'warn' : '') ?>" style="width:<?= min(100, $avg) ?>%">
            </div>
          </div>
        </div>
        <div class="stat-card fade-up">
      ...
      <div class="panel fade-up">
        <div class="panel-header">
          <span class="panel-title">Latest Methane Readings (All Users)</span>
            ...
            <table class="data-table">
              ...
              <tbody>
                ...
                <?php if (!$latestMethane): ?>
                  <tr>
                    <td colspan="4" class="text-center text-muted" style="padding:32px">No readings yet.</td>
                  </tr>
                <?php endif; ?>
              </tbody>
            </table>
