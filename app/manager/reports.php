  ...
  <div class="main-content">
    ...
    <div class="page-body">
      ...
      <div class="flex gap-2 mb-2" style="flex-wrap:wrap;">
        <?php foreach (['methane'=>'⚠️ Methane','gas_usage'=>'📊 Gas Usage','gas_level'=>'🫙 Gas Level'] as $k=>$l): ?>
      ...
      <div class="panel fade-up">
        <div class="panel-header">
          <span class="panel-title">
            <?= $tab==='methane'?'⚠️ All Methane Readings':($tab==='gas_usage'?'📊 All Gas Usage':'🫙 All Gas Levels') ?>
          </span>
        </div>
        <div class="panel-body">
          <div class="table-wrap">
            ...
            <?php elseif ($tab === 'gas_usage'): ?>
              ...
              <table class="data-table">
                <thead><tr><th>#</th><th>User</th><th>Flow Rate (L/min)</th><th>Gas Used (L)</th><th>Recorded At</th></tr></thead>
                <tbody>
                  <?php foreach ($rows as $r): ?>
                  <tr>
                    <td class="mono text-sm text-muted"><?= $r['id'] ?></td>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="gauge-bar mt-1" style="width:100px"><div class="gauge-fill <?= $r['gas_percentage']<25?'danger':($r['gas_percentage']<50?'warn':'') ?>" style="width:<?= min(100,$r['gas_percentage']) ?>%"></div></div>
                    </td>
                    <td class="text-sm text-muted"><?= $r['recorded_at'] ?></td>
                  </tr>
                  <?php endforeach; ?>
